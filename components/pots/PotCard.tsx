    ...
    <Card className="flex h-full flex-col">
      <div className="flex items-start justify-between gap-4">
        ...
        <div className="text-right">
          ...
          <p className="mt-2 text-preset-3 text-grey-900">{formatCurrency(pot.target)}</p>
        </div>
      </div>

      <div className="mt-6">
        <div className="flex items-center justify-between gap-4 text-preset-4">
          <span className="font-bold text-secondary-red">{formatCurrency(-pot.total)}</span>
        ...
        <p className="mt-2 text-preset-5 text-grey-500">{Math.round(pct)}% of target</p>
      </div>
