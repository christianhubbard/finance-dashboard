...
export function BalanceCards({ balance }: BalanceCardsProps) {
  return (
    <div className="grid grid-cols-3 gap-6">
      <div className="@container min-w-0 overflow-hidden rounded-2xl bg-inverse px-6 py-6 text-inverse-foreground">
        <p className="text-preset-4 text-inverse-muted">Current Balance</p>
      ...
      <div className="@container min-w-0 overflow-hidden rounded-2xl bg-card px-6 py-6">
        <p className="text-preset-4 text-muted-foreground">Income</p>
        <p className="mt-4 text-balance-amount font-bold tracking-tight tabular-nums text-secondary-green">
          +{formatCurrency(balance.income)}
        </p>
      </div>
      <div className="@container min-w-0 overflow-hidden rounded-2xl bg-card px-6 py-6">
        <p className="text-preset-4 text-muted-foreground">Expenses</p>
