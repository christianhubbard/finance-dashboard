          ...
          return (
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                <p className="text-preset-4-bold truncate text-foreground">
                  {tx.name}
                </p>
                <div className="mt-1 flex flex-wrap items-center gap-x-2 gap-y-0 text-preset-5 text-muted-foreground">
