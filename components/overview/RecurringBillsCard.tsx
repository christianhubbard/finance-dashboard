...
export function RecurringBillsCard({ data }: RecurringBillsCardProps) {
  ...
  return (
    <Card>
      <h2 className="text-preset-2 text-foreground">Recurring Bills</h2>
      <ul className="mt-6 flex flex-col gap-3">
        <li className="flex items-center justify-between gap-4 rounded-xl border border-subtle bg-surface/60 px-4 py-4">
          <div>
            <p className="text-preset-4-bold text-secondary-green">Paid Bills</p>
            <p className="text-preset-5 text-muted">
              {paid.length} bills
            </p>
          </div>
