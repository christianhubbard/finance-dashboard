...
export function RecurringBillsCard({ data }: RecurringBillsCardProps) {
  ...
  return (
    <Card>
      <h2 className="text-preset-2 text-grey-900 dark:text-grey-100">Recurring Bills</h2>
      <ul className="mt-6 flex flex-col gap-3">
        <li className="flex items-center justify-between gap-4 rounded-xl border border-beige-100 bg-beige-100/60 px-4 py-4 dark:border-white/10 dark:bg-white/5">
          <div>
        ...
        <li className="flex items-center justify-between gap-4 rounded-xl border border-beige-100 bg-beige-100/60 px-4 py-4 dark:border-white/10 dark:bg-white/5">
          ...
          <p className="text-preset-1 font-bold tracking-tight text-grey-900 dark:text-grey-100">
            {dueSoon.length}
          </p>
        </li>
      </ul>
